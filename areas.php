...
<html>
  <head>
    <meta charset="UTF-8">
    <title>Colegio Grancolombiano | Áreas </title>
        ...
        <section class="content">
              <div class="box">
                <div class="box-header">
           			<h3 class="box-title">Tablero de áreas</h3> 
                </div><!-- /.box-header -->
                <div class="box-body">
                  <?php if($num>0) {?>
                  <table id="example1" class="table table-bordered table-striped">
					...
					<?php while($valor = mysql_fetch_assoc($q)){?>
                      <tr>
                        ...
                        <td><?php echo $valor['area_name']; ?></td>
                    ...
                    <tfoot>
                      ...
                      <?php } else { ?>
            				<h3 class="box-title">No hay áreas agregadas en el momento.</h3>
