...
$q = mysql_query("SELECT indicator_cod, indicator_name, indicator_description, equation_id, chart_type, indicator_goal FROM indicators WHERE indicator_id=$query_id",$link);
