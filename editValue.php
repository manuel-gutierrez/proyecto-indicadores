...
$q = mysql_query("SELECT * FROM indicatorvalues WHERE value_id=$query_id", $link);
$valores = mysql_fetch_assoc($q);
$fecha = $valores['value_date'];
$valor = $valores['value_ind'];
      ...
      <div class="content-wrapper">
        ...
        <section class="content-header">
          ...
          <ol class="breadcrumb">
            ...
            <li >Indicadores</li>
            <li class="active">Editar valor</li>
          </ol>
        </section>
        ...
        <section class="content">
              <div class="box">
                <div class="box-header">
           			<h3 class="box-title">Editar valor de indicador</h3> 
                </div><!-- /.box-header -->
                <div class="box-body">
                <!-- form start -->
                <form class="form-horizontal" action="editValue.php?id=<?php echo $query_id; ?>" method="post">
                <div class="col-md-6">
                	<div class="row">
                    <div class="form-group">
                      <label for="date" class="col-sm-2 control-label">Fecha</label>
                      <div class="col-sm-10">
                        <input type="text" name="date" value="<?php echo $fecha;?>" class="form-control"/>
                      </div>
                    </div>
                    </div>
                    <div class="row">
                    <div class="form-group">
                      ...
                      <div class="col-sm-10">
                        <input type="text" class="form-control" name="value" id="value" value="<?php echo $valor;?>">
                      </div>
                    </div>
                     </div>
                    <div class="row">
				...
				if ($_SERVER['REQUEST_METHOD'] == 'POST') {
					if (!empty($_POST['value']) && !empty($_POST['date'])) {
						$value = $_POST['value'];
						$date = $_POST['date'];
						echo ("Se editó el valor: La nueva fecha es $date y el nuevo valor es $value. Por favor cierre la ventana y actualice para continuar");
						$q = mysql_query("UPDATE indicatorvalues SET value_date = '$date', value_ind = '$value' WHERE value_id = '$query_id'", $link);
						reportes_action([0 => 'Edición de Indicador', 1 => 'editValue', 2 => 'Se editó un indicador con valor '.$value.', en el 				sistema.']);
						} else {
