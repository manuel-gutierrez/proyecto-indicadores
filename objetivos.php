...
<html>
  <head>
    <meta charset="UTF-8">
    <title>Colegio Grancolombiano | Objetivos </title>
        ...
        <section class="content">
              <div class="box">
                <div class="box-header">
           			<h3 class="box-title">Tablero de objetivos</h3> 
                </div><!-- /.box-header -->
                <div class="box-body">
                  <?php if($num>0) {?>
                  <table id="example1" class="table table-bordered table-striped">
					...
					<?php while($valor = mysql_fetch_assoc($q)){?>
                      <tr>
                        ...
                        <td><?php echo $valor['objective_name']; ?></td>
<!--                        <td><?php echo $valor['area_description']; ?></td> -->
                      </tr> <?php } ?>
                    </tbody>
                    <tfoot>
                      <tr>
                      ...
                      <?php } else { ?>
            				<h3 class="box-title">No hay objetivos agregados en el momento.</h3>
