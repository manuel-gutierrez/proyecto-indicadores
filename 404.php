        ...
        <section class="content">
          <div class="error-page">
            ...
            <div class="error-content">
              <h3><i class="fa fa-warning text-yellow"></i> Ups! La página no está disponible.</h3>
              <p>
                En el momento no está disponible la página que está buscando. 
                Regrese a la <a href="<?php if ($login_usertype == 0) {echo "inicio.php"; } else {echo "inicio1.php"; } ?>">
                	página de inicio</a> e inténtelo más tarde.
              </p>
            </div><!-- /.error-content -->
          </div><!-- /.error-page -->
        </section><!-- /.content -->
